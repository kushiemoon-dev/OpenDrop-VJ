...
//!
//! Ported from `phase0-spike/src/main.rs` (a pattern already proven there),
...
/// current EGL context. Same loader the Phase 0 spike used
/// (`phase0-spike/src/main.rs`'s `make_gl`); the glutin-side equivalent in
