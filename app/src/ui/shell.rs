...
//! module doc comment); the same two-struct idiom `ui::preset_browser::show`
...
pub fn nav(ui: &mut egui::Ui, shell: &mut ShellCtx) {
    ...
    ui.vertical(|ui| {
        ...
        egui::ScrollArea::vertical().show(ui, |ui| {
            ...
            nav_item(ui, shell.active_panel, Panel::RkbxLink, "rkbx_link", &mut active_rect);
            ...
            nav_item(ui, shell.active_panel, Panel::CloudVideo, "Cloud Video", &mut active_rect);
            #[cfg(feature = "link")]
