export type CommandId =
  ...
  | 'colorkey-hue-2'
  | 'colorkey-hue-3'
  | 'colorkey-tolerance-0'
  | 'colorkey-tolerance-1'
  | 'colorkey-tolerance-2'
  | 'colorkey-tolerance-3'
...
const DEFAULT_COMMANDS: Command[] = [
  ...
  },
  {
    ...
    kind: 'trigger',
    run(_, ctx) {
      ctx.navigatePreset(ctx.getActiveDeck(), -1)
    },
  },
  {
  ...
  },
  {
    ...
    kind: 'trigger',
    run(_, ctx) {
      ctx.togglePlaylist(ctx.getActiveDeck())
    },
  },
  {
    ...
    kind: 'trigger',
    run(_, ctx) {
      ctx.playlistPrev(ctx.getActiveDeck())
    },
  },
  {
    ...
    kind: 'trigger',
    run(_, ctx) {
      ctx.playlistNext(ctx.getActiveDeck())
    },
  },
  ...
  // Overlay queue (auto-cycle)
  {
    id: 'overlay-queue-next',
    label: 'Overlay Queue Next',
    kind: 'trigger',
    run(_, ctx) {
      ctx.advanceOverlayQueue(1)
    },
  },
  {
    id: 'overlay-queue-prev',
    label: 'Overlay Queue Prev',
    kind: 'trigger',
    run(_, ctx) {
      ctx.advanceOverlayQueue(-1)
    },
