...
export async function toggleMidi(midi: MidiEngine | null, deps: ToggleMidiDeps): Promise<MidiEngine | null> {
	const { registry, commandCtx, clock, getCommandCurrentValue, getCommandLedState, pushLedStates } = deps;
